...
Challenge = import_string(settings.CHALLENGES_MODEL)
...
class Post(UserInfo):
    ...
    challenge = models.ForeignKey(Challenge, on_delete=models.CASCADE, null=True, blank=True, related_name="challenge_posts")
