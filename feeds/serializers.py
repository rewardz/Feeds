...
from .utils import (
    ...
    get_feed_type, get_user_reaction_type, get_user_localtime
)
...
class ImagesSerializer(serializers.ModelSerializer):
    ...
    #     print(value)
    #     print(value.split(".")[-1].lower() not in ["png", "jpg", "jpeg"])
    ...
    #     if "image" in data:
    #         self.validate_name(data["image"].name)
    #     return data
...
class CategoriesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "name", "img", "is_group_nomination", "can_attach_badge")
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        created_on = get_user_localtime(instance.created_on, user.organization.timezone,
                                        date_format="%Y-%m-%d %H:%M:%S") if user else instance.created_on.strftime(
            "%Y-%m-%d %H:%M:%S")
